...
top_cn_dir="results/cn/topbottom-llama3-8B-top_cn_bag.json"
inter_cn_dir="results/cn/topbottom-llama3-8B-intersection_cn_bag.json"
bottom_cn_dir="results/cn/topbottom-llama3-8B-bottom_cn_bag.json"
...
out_root="eval_results/outputs"
metric_root="eval_results/metrics"
